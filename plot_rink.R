...
plot_rink = function(p_object){
  ...
  p = p_object +
    ...
    ## FACEOFF DOTS ##
    geom_point(inherit.aes = FALSE, aes(y = 42.5, x = 100), col = "gray50") +
    geom_point(inherit.aes = FALSE, aes(y = 20.5, x = 169), col = "gray50") +
    geom_point(inherit.aes = FALSE, aes(y = 64.5, x = 169), col = "gray50") +
    geom_point(inherit.aes = FALSE, aes(y = 20.5, x = 120), col = "gray50") +
    geom_point(inherit.aes = FALSE, aes(y = 64.5, x = 120), col = "gray50") +
    geom_point(inherit.aes = FALSE, aes(y = 20.5, x = 31), col = "gray50") +
    geom_point(inherit.aes = FALSE, aes(y = 64.5, x = 31), col = "gray50") +
    geom_point(inherit.aes = FALSE, aes(y = 20.5, x = 80), col = "gray50") +
    geom_point(inherit.aes = FALSE, aes(y = 64.5, x = 80), col = "gray50") +
    ## BLUE AND RED LINES ##
